...
from ptask_ftr.algorithms.marl.maddpg import MADDPG as TrainAlgo
from ptask_ftr.algorithms.marl.maddpg import MADDPG_policy as Policy
from ptask_ftr.algorithms.marl.maddpg import ReplayBuffer
