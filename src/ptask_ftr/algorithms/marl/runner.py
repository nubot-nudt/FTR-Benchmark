...
from ptask_ftr.algorithms.marl.utils.separated_buffer import SeparatedReplayBuffer
from ptask_ftr.utils.util import update_linear_schedule
...
class Runner:
    ...
    def __init__(self,
        ...
        if self.algorithm_name == "happo":
            from ptask_ftr.algorithms.marl.happo_trainer import HAPPO as TrainAlgo
            from ptask_ftr.algorithms.marl.happo_policy import HAPPO_Policy as Policy
        if self.algorithm_name == "hatrpo":
            from ptask_ftr.algorithms.marl.hatrpo_trainer import HATRPO as TrainAlgo
            from ptask_ftr.algorithms.marl.hatrpo_policy import HATRPO_Policy as Policy
        if self.algorithm_name == "mappo":
            from ptask_ftr.algorithms.marl.mappo_trainer import MAPPO as TrainAlgo
