...
from pumbaa.common.default import flipper_length as _flipper_length
from pumbaa.common.default import flipper_joint_x
from pumbaa.common.default import flipper_joint_y
...
def robot_flipper_positions(flipper_angle, degree=True, flipper_length=_flipper_length):
    '''
