...
class DiscreteStd5(ActionMode):
    ...
    @property
    def gym_space(self):
        return spaces.Tuple([spaces.Discrete(7), spaces.Discrete(3), spaces.Discrete(3), spaces.Discrete(3), spaces.Discrete(3)])
...
ActionModeFactory.register('continuous_std_6', ContinuousStd6)
ActionModeFactory.register('continuous_std_5', ContinuousStd5)
ActionModeFactory.register('continuous_std_4', ContinuousStd4)
ActionModeFactory.register('discrete_std_4', DiscreteStd4)
ActionModeFactory.register('discrete_std_5', DiscreteStd5)
ActionModeFactory.register('discrete_std_1', DiscreteStd1)
ActionModeFactory.register('discrete_flipper_1', DiscreteFlipper1)
ActionModeFactory.register('independent_control', DiscreteFlipper1)
