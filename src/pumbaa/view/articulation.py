...
class PumbaaArticulationView(ArticulationView):
    ...
    def set_all_flipper_dt(self, dt_positions: torch.Tensor, indices=None):
    ...
    def get_all_flipper_positions(self, indices=None):
        ...
        return positions * a * 180 / torch.pi
    ...
    def find_idx(self):
        ...
        self.r_indices = [self.get_dof_index(i) for i in wheel_joint_names if i.startswith('R')]
        self.l_indices = [self.get_dof_index(i) for i in wheel_joint_names if i.startswith('L')]
