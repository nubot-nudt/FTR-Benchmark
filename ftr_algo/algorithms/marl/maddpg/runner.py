...
from ftr_algo.algorithms.marl.maddpg import MADDPG as TrainAlgo
from ftr_algo.algorithms.marl.maddpg import MADDPG_policy as Policy
from ftr_algo.algorithms.marl.maddpg import ReplayBuffer
...
class Runner:
    ...
    def eval(self, total_num_steps):
        ...
        while True:
            ...
            for agent_id in range(self.num_agents):
                self.trainer.prep_rollout()
                eval_actions, temp_rnn_state = self.trainer.policy[agent_id].act(
                    eval_obs[:, agent_id], deterministic=True
                )
