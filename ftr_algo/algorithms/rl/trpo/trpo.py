    ...
    def update(self):
        ...
        for epoch in range(self.num_learning_epochs):
            ...
            for indices in batch:
                ...
                a_loss = -torch.squeeze(advantages_batch) * torch.exp(
                ...
                evaluate_policy = lambda x: self.get_aloss_logp(
                    obs_batch,
                    states_batch,
                    actions_batch,
                    advantages_batch,
                    old_actions_log_prob_batch=x,
                )
                ...
                success, new_params = self.line_search(
                    ...
                    flat_g,
                    max_num_backtrack=self.max_num_backtrack,
