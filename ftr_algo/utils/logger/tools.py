...
def merge_csv(csv_files, root_dir, remove_zero=False):
    ...
    content = [
        ["env_step", "rew", "rew:shaded"] + list(map(lambda f: "rew:" + os.path.relpath(f, root_dir), sorted_keys))
    ]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env-num", type=int, default=2048, help="the number of parallel simulations")
    parser.add_argument(
        "--env-step",
        type=int,
        default=8,
